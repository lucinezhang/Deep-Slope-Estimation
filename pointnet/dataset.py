...
class KittiNormalEst(data.Dataset):
    def __init__(self, stage='train'):
        ...
        h5_city = '/scratch/yujiac2/data/kitti/city25.h5'
        h5_resi = '/scratch/yujiac2/data/kitti/resi25.h5'
        h5_road = '/scratch/yujiac2/data/kitti/road25.h5'
        h5_campus = '/scratch/yujiac2/data/kitti/campus25.h5'
